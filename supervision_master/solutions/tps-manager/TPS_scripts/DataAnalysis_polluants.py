...
# http://localhost:54350/REDMET_MERRA/stadistics_all_data/


metaworkflow=Builder("REDMET_MERRA",TPS_manager_host="http://localhost:54350")

metaworkflow.TPSapi.PutData('polluants.csv',"poll")
...
query = metaworkflow.TPSapi.format_single_query("all_data") #query to a single task
