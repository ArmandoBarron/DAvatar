...
function successCallBackStruct(returnData) {
  info = JSON.parse(returnData);
...
function loadStructure()
{
  ...
  $.ajax({
    ...
    type: "POST",
    async: true,
    data: {action:"appStruct",app:app},
    success: successCallBackStruct
  });
}
...
function successCallBackStat(returnData) {
  info = JSON.parse(returnData);
  let res = JSON.parse(info);
  prepareStatus(res);
...
function loadStatus()
{
  ...
  $.ajax({
    ...
    type: "POST",
    async: true,
    data: {action:"appStatus",app:app},
    success: successCallBackStat
  });
}
