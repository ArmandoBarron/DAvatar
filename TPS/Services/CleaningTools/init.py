...
def Basic_cleaning(columns='all',ReplaceWithNa=["NA","NAN","NaN","None"],DropNa=None,NaReaplace="",DataTypes=[]):
    ...
    if columns == "all":
        ...
        elif NaReaplace =="median": DF_data= DF_data.fillna(DF_data.median())
        ...
        for col in columns:
            ...
            elif NaReaplace =="median": DF_data[col]= DF_data[col].fillna(DF_data[col].median())
